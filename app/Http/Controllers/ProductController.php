...
class ProductController extends Controller
{
    ...
    {
        // withTrashed()-> untuk mengembalikan
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.products.index')->with('succes', 'Product Created Succesfully!');
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function destroy(Product $product)
    {
        ...
        try {
            $product->delete();
            return redirect()->route('admin.products.index')->with('succes', 'Product deleted Succesfully!');
        } catch (Exception $e) {
            $error = ValidationException::withMessages([
                'system_error' => ['System error!' . $e->getMessage()],
            ]);
